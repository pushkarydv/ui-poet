...
/**
 * Generates a prompt for the UI observer.
 * @param {string} IMAGE_PRE_PROMPT - The pre-prompt image for the UI observer.
 * @returns {string} - The generated prompt for the UI observer.
 */

function UI_OBSERVER_PROMPT(IMAGE_PRE_PROMPT) {
  ...
  5. Provide positions of different elements in the UI, like where the buttons are, where the text is, where the images are, etc.
...
/**
 * Generates a prompt for the code generator.
 * @param {string} IMAGE_PRE_PROMPT - The pre-prompt image for the code generator.
 * @param {string} analysisMessage - The analysis message generated by the UI observer.
 * @returns {string} - The generated prompt for the code generator.
 */
